  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      id: '1',
      type: 'assistant',
      content: "Hi! I'm Lexio your learning assistant. I can help you build your listening queue by intelligently analyzing your learning interests. Just tell me what you want to learn about, and I'll automatically find and add relevant sections to your queue! Or ask me anything about the content.",
      timestamp: new Date(),
    }
  ]);
